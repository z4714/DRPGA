...
maddpg = maddpg.MADDPG(env, device, actor_lr, critic_lr, hidden_dim, state_dims, action_dims, critic_input_dim, gamma, tau)
...
for i_episode in range(num_episodes):   
    ...
    ep_returns = rl_tools.evaluate(env, maddpg, n_episode=100)
...
save_model.save_actor_critic(maddpg)
